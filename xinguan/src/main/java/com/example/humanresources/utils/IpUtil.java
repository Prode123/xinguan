...
import com.example.humanresources.entity.IpAddress;
...
public class IpUtil {
    ...
    public static String getAddress(String ip) {
        String result = sendPost("https://ip.taobao.com/outGetIpInfo", "ip=" + ip + "&accessKey=alibaba-inc");
        ObjectMapper mapper = new ObjectMapper();
        IpAddress ipAddress = null;
        try {
            ipAddress = mapper.readValue(result, IpAddress.class);
